...
export interface ServiceApprovalRule { id: string; sequence: number; approvalType: 'MANAGER'|'GROUP'|'SPECIFIC_USER'; approvalGroupId?: string; specificApproverId?: string; active: boolean }
