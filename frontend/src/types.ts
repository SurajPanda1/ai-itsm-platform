...
export interface Incident {
  ...
  change?: { changeType?: string; risk?: string; impact?: string; plannedStart?: string; plannedEnd?: string; implementationPlan?: string; backoutPlan?: string; testPlan?: string; actualStart?: string; actualEnd?: string; requestedBy?: Pick<User, 'id' | 'name' | 'email'> };
