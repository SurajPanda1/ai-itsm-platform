...
export interface KnowledgeArticle { id: string; articleNumber: string; title: string; category: string; status: 'DRAFT'|'PUBLISHED'|'ARCHIVED'; summary?: string; content?: string; keywords?: string; createdAt: string; updatedAt: string; publishedAt?: string; createdBy?: Pick<User, 'id' | 'name' | 'email'>; updatedBy?: Pick<User, 'id' | 'name' | 'email'> }
